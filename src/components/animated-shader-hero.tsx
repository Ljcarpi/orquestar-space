      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
        ...
        {trustBadge && (
          <div className="mb-8 animate-fade-in-down">
            <div className="flex items-center gap-2 px-6 py-3 backdrop-blur-md rounded-full text-sm"
              ...
              <span style={{ color: '#f0e6d3', fontFamily: 'DM Sans, sans-serif' }}>{trustBadge.text}</span>
            </div>
          </div>
        )}
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto animate-fade-in-up animation-delay-600">
            <div className="text-lg md:text-xl lg:text-2xl font-light leading-relaxed"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 animate-fade-in-up animation-delay-800">
              {buttons.primary && (
                <button
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #d4a843 0%, #b8892a 60%, #e8c068 100%)',
                    color: '#0a0118',
                    boxShadow: '0 4px 24px rgba(212,168,67,0.45)',
